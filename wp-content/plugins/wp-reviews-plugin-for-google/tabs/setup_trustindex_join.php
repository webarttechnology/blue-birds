...
$serverOutput = $trustindex_pm_google->connect_trustindex_api([
'signin' => [
...
$trustindexSubscriptionId = $trustindex_pm_google->is_trustindex_connected();
$widgetNumber = $trustindex_pm_google->get_trustindex_widget_number();
?>
...
- <?php echo TrustindexPlugin_google::___('Your subscription ID:'); ?> <strong><?php echo esc_html($trustindexSubscriptionId); ?></strong><br />
<?php if ($tiPackage): ?>
- <?php echo TrustindexPlugin_google::___('Your package:'); ?> <strong><?php echo esc_html(TrustindexPlugin_google::___($tiPackage)); ?></strong>
<?php endif; ?>
</p>
<?php if ($tiPackage === 'free'): ?>
<?php echo TrustindexPlugin_google::get_noticebox('error', TrustindexPlugin_google::___("Once the trial period has expired, the widgets will not appear. You can subscribe or switch back to the \"%s\" tab", [ TrustindexPlugin_google::___('Free Widget Configurator') ])); ?>
<?php elseif ($tiPackage === 'trial'): ?>
<?php echo TrustindexPlugin_google::get_noticebox('warning', TrustindexPlugin_google::___("Once the trial period has expired, the widgets will not appear. You can subscribe or switch back to the \"%s\" tab", [ TrustindexPlugin_google::___('Free Widget Configurator') ])); ?>
<?php endif; ?>
...
<button type="submit" class="btn btn-primary"><?php echo TrustindexPlugin_google::___('CONNECT ACCOUNT');?></button>
<br />
<p class="text-center">
...
<?php if ($widgetNumber): ?>
<p>
<?php echo TrustindexPlugin_google::___('You have got %d widgets saved in Trustindex admin.', [ $widgetNumber ]); ?>
</p>
...
<code class="code-ti-w-<?php echo esc_attr($wcIndex .'-'. $wiNum); ?>">[<?php echo $trustindex_pm_google->get_shortcode_name(); ?> data-widget-id="<?php echo esc_attr($w['id']); ?>"]</code>
<a href=".code-ti-w-<?php echo esc_attr($wcIndex .'-'. $wiNum); ?>" class="btn-text btn-copy2clipboard"><?php echo TrustindexPlugin_google::___('Copy to clipboard'); ?></a>
<br />
<br />
</div>
</li>
