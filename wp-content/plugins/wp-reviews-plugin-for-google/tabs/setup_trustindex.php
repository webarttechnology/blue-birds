...
<h2>
<?php echo TrustindexPlugin_google::___('%s+ WordPress websites use Trustindex to embed reviews fast and easily.', [ '300.000' ]); ?><br />
...
<li><?php echo TrustindexPlugin_google::___('%d review platforms', [ 133 ]); ?></li>
