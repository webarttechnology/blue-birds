                     ...
                     <div class="auto-container">
                         <div class="content-box">
                             <div class="content">
                                 <div class="clearfix">
                                     <div class="inner">
                                         <div class="bg-image"><img src="images/main-slider/banner-icon-1.svg" alt=""
                                                 title=""></div>
                                         <h1><span><i class="bg-vector"><img src="images/resource/title-pattern-1.svg"
     ...
     <div class="auto-container">
         <div class="inner">
             <div class="content">
                 ...
                 <div class="phone"><a href="tel:+1 403.613.8074"><i class="icon far fa-phone"></i><span>+1
                             403.613.8074</span></a></div>
             </div>
         </div>
     </div>
     <div class="cursor cursor--large"></div>
             ...
             <div class="text-col col-md-12">
                 <div class="inner wow fadeInRight" data-wow-duration="1500ms" data-wow-delay="0ms">
                     <div class="title-box">
                         ...
                         <h2><i class="bg-vector"><img src="images/resource/title-pattern-1.svg"
                                     alt=""></i><span>Discover Excellence at Blue Bird Driving School – Calgary's Top
                                 Choice! </span></h2>
                     </div>
                     <div class="text-content text">With over 5 years of expertise in Alberta, we specialize in crafting
                         skilled, defensive, and safe drivers. Our patient, professional instructors are dedicated to
                         your success, as reflected in our high passing rate of over 95%. Join us and experience driving
                         excellence!</div>
                     <div class="row clearfix">
                         <!--Block-->
                         <div class="wel-block col-md-4">
                             <div class="inner-box">
                                 <div class="icon"><img src="images/ins 1.png" alt=""></div>
                                 <h4>Certified Instructors</h4>
                                 <div class="text">Certified Instructors: Learn from the best with our expert certified
                                     instructors guiding you every step of the way.</div>
                             </div>
                         </div>
                         <!--Block-->
                         <div class="wel-block col-md-4">
                             <div class="inner-box">
                                 <div class="icon"><img src="images/rent 1.png" alt=""></div>
                                 <h4>Car Rentals</h4>
                                 <div class="text">Car Rentals: Enjoy the convenience of hassle-free car rentals for
                                     your driving lessons, ensuring a seamless learning experience.</div>
                             </div>
                         </div>
                         <!--Block-->
                         <div class="wel-block col-md-4">
                             <div class="inner-box">
                                 <div class="icon"><img src="images/inscu 1.png" alt=""></div>
                                 <h4>Insurance Reduction Courses</h4>
                                 <div class="text"> Enroll in our specialized courses to reduce insurance premiums while
                                     enhancing your driving skills.</div>
                             </div>
                         </div>
                         <!--Block-->
                         <div class="wel-block col-md-4">
                             <div class="inner-box">
                                 <div class="icon"><img src="images/plsns 1.png" alt=""></div>
                                 <h4>Personalized Lessons</h4>
                                 <div class="text">Tailored lessons designed to meet your specific needs, providing
                                     focused and effective learning.</div>
                             </div>
                         </div>
                         <div class="wel-block col-md-4">
                             <div class="inner-box">
                                 <div class="icon"><img src="images/lrnng 1.png" alt=""></div>
                                 <h4>Self Paced Learning</h4>
                                 <div class="text">Progress at your own speed with our flexible self-paced learning
                                     options, empowering you to learn comfortably.</div>
                             </div>
                         </div>
                         <div class="wel-block col-md-4">
                             <div class="inner-box">
                                 <div class="icon"><img src="images/scl 1.png" alt=""></div>
                                 <h4>Top-Rated School</h4>
                                 <div class="text">Choose the top-rated driving school in town, where quality education
                                     and excellent service are our top priorities.</div>
                             </div>
                         </div>
                     </div>
 ...
 <section class="services-one d-none">
     <div class="auto-container">
         <div class="title-box centered">
             <div class="dots"><span></span></div>
             <h2><i class="bg-vector"><img src="images/resource/title-pattern-1.svg" alt=""></i><span>Check out latest
                     <br>Services</span></h2>
         </div>
         <div class="row clearfix">
             <!--Block-->
 ...
 <section class="why-us d-none">
     <div class="auto-container">
         <div class="title-box">
             <div class="dots"><span></span></div>
             <h2><i class="bg-vector"><img src="images/resource/title-pattern-1.svg" alt=""></i><span>Why Choose
                     Us</span></h2>
         </div>
 ...
 <section class="why-us mb-5">
     <div class="auto-container">
         <div class="title-box">
             <div class="dots"><span></span></div>
             <h2><i class="bg-vector"><img src="images/resource/title-pattern-1.svg" alt=""></i><span>Our Four-step
                     Process</span></h2>
         </div>
         <div class="row clearfix">
             <div class="col-md-3">
                 <div class="why-block">
                     <div class="inner-box">
                         <div class="icon-box"><span class="fal fa-phone"></span></div>
                         <h4>Call</h4>
                         <div class="text">Call us to find out the right driving lesson packages that suit your needs.
                         </div>
                     </div>
                 </div>
             </div>
             <div class="col-md-3">
                 <div class="why-block">
                     <div class="inner-box">
                         <div class="icon-box"><span class="fal fa-clock"></span></div>
                         <h4>Appointment</h4>
                         <div class="text">Plan and make an appointment for your driving lessons.</div>
                     </div>
                 </div>
             </div>
             <div class="col-md-3">
                 <div class="why-block">
                     <div class="inner-box">
                         <div class="icon-box"><span class="fal fa-users"></span></div>
                         <h4>Road Test</h4>
                         <div class="text">Once you are ready, take the road test</div>
                     </div>
                 </div>
             </div>
             <div class="col-md-3">
 ...
 <section class="team-section d-none">
     ...
     <div class="auto-container">
         <div class="title-box centered">
             <div class="dots"><span></span></div>
             <h2><i class="bg-vector"><img src="images/resource/title-pattern-1.svg" alt=""></i><span>Meet Our Expert
         ...
         <div class="carousel-box">
             <div class="team-carousel owl-theme owl-carousel">
                 ...
                 <div class="team-block">
                     <div class="inner-box">
                         <div class="image-box">
                             <div class="image"><img src="images/resource/team-1.jpg" alt="" title=""></div>
                         </div>
                         <div class="lower">
                 ...
                 <div class="team-block">
                     <div class="inner-box">
                         <div class="image-box">
                             <div class="image"><img src="images/resource/team-2.jpg" alt="" title=""></div>
                         </div>
                         <div class="lower">
                 ...
                 <div class="team-block">
                     <div class="inner-box">
                         <div class="image-box">
                             <div class="image"><img src="images/resource/team-3.jpg" alt="" title=""></div>
                         </div>
                         <div class="lower">
 ...
 <section class="programs-section d-none">
     <div class="auto-container">
         <div class="title-box">
             <div class="dots"><span></span></div>
             <h2><i class="bg-vector"><img src="images/resource/title-pattern-1.svg" alt=""></i><span>Latest
                     Resources</span></h2>
         </div>
         <div class="carousel-box">
             <div class="programs-carousel owl-theme owl-carousel">
                 ...
                 <div class="program-block">
                     <div class="inner-box">
                         <div class="image-box">
                             <div class="image"><img src="images/resource/image-4.jpg" alt="" title=""></div>
                         </div>
                         <div class="hvr-box">
                             <div class="hvr-content">
                                 <div class="link"><a href="#"><span class="fa-light fa-long-arrow-right"></span></a>
         ...
         <div class="carousel-box">
             <div class="programs-carousel program-block-two owl-theme owl-carousel">
                 ...
                 <div class="program-block">
                     <div class="inner-box">
                         <div class="image-box">
                             <div class="image"><a href="#"><img src="images/alberta_drivers- guide-min.png" alt=""
                                         title=""></a></div>
                             <div class="icon-box"><img src="images/resource/steering-icon.svg" alt="" title=""></div>
                         </div>
                         <div class="mid-box">
                 ...
                 <div class="program-block">
                     <div class="inner-box">
                         <div class="image-box">
                             <div class="image"><a href="#"><img src="images/resource/image-13.jpg" alt="" title=""></a>
                             </div>
                             <div class="icon-box"><img src="images/resource/steering-icon.svg" alt="" title=""></div>
                         </div>
                         <div class="mid-box">
                 ...
                 <div class="program-block">
                     <div class="inner-box">
                         <div class="image-box">
                             <div class="image"><a href="#"><img src="images/alberta_transportation-min.jpg" alt=""
                                         title=""></a></div>
                             <div class="icon-box"><img src="images/resource/steering-icon.svg" alt="" title=""></div>
                         </div>
                         <div class="mid-box">
                 ...
                 <div class="program-block">
                     <div class="inner-box">
                         <div class="image-box">
                             <div class="image"><a href="#"><img src="images/traffic_ safety programs-min.jpg" alt=""
                                         title=""></a></div>
                             <div class="icon-box"><img src="images/resource/steering-icon.svg" alt="" title=""></div>
                         </div>
                         <div class="mid-box">
 ...
 <section class="testimonial-section mb-5">
     <div class="container-fluid p-0">
         <div class="title-box centered">
             <div class="dots"><span></span></div>
             <h2><i class="bg-vector"><img src="images/resource/title-pattern-1.svg" alt=""></i><span>Check what people
                     say about.</span></h2>
         </div>
 ...
 <section class="testimonial-section d-none">
     <div class="auto-container">
         <div class="title-box centered">
             <div class="dots"><span></span></div>
             <h2><i class="bg-vector"><img src="images/resource/title-pattern-1.svg" alt=""></i><span>Check what
                     <br>people say about.</span></h2>
         </div>
         <div class="carousel-box">
             <div class="def-images">
                 <div class="inner clearfix">
                     <div class="image image-1"><img src="images/resource/testi-1.png" alt="" title=""></div>
                     <div class="image image-2"><img src="images/resource/testi-2.png" alt="" title=""></div>
                     <div class="image image-3"><img src="images/resource/testi-4.png" alt="" title=""></div>
                     <div class="image image-4"><img src="images/resource/testi-3.png" alt="" title=""></div>
                     <div class="image image-5"><img src="images/resource/testi-5.png" alt="" title=""></div>
                 </div>
             </div>
             <div class="testi-carousel-one owl-theme owl-carousel">
                 ...
                 <div class="testi-block">
                     <div class="inner-box">
                         <div class="image-box">
                             <div class="image"><img src="images/resource/testi-1.png" alt="" title=""></div>
                         </div>
                 ...
                 <div class="testi-block">
                     <div class="inner-box">
                         <div class="image-box">
                             <div class="image"><img src="images/resource/testi-2.png" alt="" title=""></div>
                         </div>
                         <div class="text-content">
                             <div class="text">Ipsum dolor sit amet, consectetur adipisicing elit sed do eiusmod tempor
                                 incididunt labore etuy dolore magna aduras minim veniam, quis nostrud exercitation
                 ...
                 <div class="testi-block">
                     <div class="inner-box">
                         <div class="image-box">
                             <div class="image"><img src="images/resource/testi-3.png" alt="" title=""></div>
                         </div>
                         <div class="text-content">
                             <div class="text">Ipsum dolor sit amet, consectetur adipisicing elit sed do eiusmod tempor
                                 incididunt labore etuy dolore magna aduras minim veniam, quis nostrud exercitation
                 ...
                 <div class="testi-block">
                     <div class="inner-box">
                         <div class="image-box">
                             <div class="image"><img src="images/resource/testi-4.png" alt="" title=""></div>
                         </div>
                         <div class="text-content">
                             <div class="text">Ipsum dolor sit amet, consectetur adipisicing elit sed do eiusmod tempor
                                 incididunt labore etuy dolore magna aduras minim veniam, quis nostrud exercitation
                 ...
                 <div class="testi-block">
                     <div class="inner-box">
                         <div class="image-box">
                             <div class="image"><img src="images/resource/testi-5.png" alt="" title=""></div>
                         </div>
                         <div class="text-content">
                             <div class="text">Ipsum dolor sit amet, consectetur adipisicing elit sed do eiusmod tempor
                                 incididunt labore etuy dolore magna aduras minim veniam, quis nostrud exercitation
 ...
 <section class="news-section d-none">
     <div class="auto-container">
         <div class="title-box centered">
             <div class="dots"><span></span></div>
             <h2><i class="bg-vector"><img src="images/resource/title-pattern-1.svg" alt=""></i><span>Latest news &
                     <br>update</span></h2>
         </div>
         <div class="news-box">
             <div class="row clearfix">
                 ...
                 <div class="news-block col-xl-4 col-lg-6 col-md-6 col-sm-12">
                     <div class="inner-box wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="0ms">
                         <div class="image-box">
                             <div class="image"><a href="#"><img src="images/resource/news-1.jpg" alt="" title=""></a>
                             </div>
                         </div>
                         <div class="lower-box">
                 ...
                 <div class="news-block col-xl-4 col-lg-6 col-md-6 col-sm-12">
                     <div class="inner-box wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="300ms">
                         <div class="image-box">
                             <div class="image"><a href="#"><img src="images/resource/news-2.jpg" alt="" title=""></a>
                             </div>
                         </div>
                         <div class="lower-box">
                             <div class="info">Personal / June 13, 2022</div>
                 ...
                 <div class="news-block col-xl-4 col-lg-6 col-md-6 col-sm-12">
                     <div class="inner-box wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="600ms">
                         <div class="image-box">
                             <div class="image"><a href="#"><img src="images/resource/news-3.jpg" alt="" title=""></a>
                             </div>
                         </div>
                         <div class="lower-box">
                             <div class="info">Personal / June 13, 2022</div>
         ...
         <div class="row clearfix">
             <div class="title-col col-md-12">
                 <div class="inner">
                     ...
                     <div class="link text-center mt-4"><a href="#" class="theme-btn btn-style-one"><span>Schedule
                                 Lessons</span></a></div>
                 </div>
             </div>
