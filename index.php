 <?php include('header.php') ?>
                            ...
                            <div class="content">
                                <div class="clearfix">
                                    <div class="inner">
                                        ...
                                        <h1><span><i class="bg-vector"><img src="images/resource/title-pattern-1.svg" alt=""></i>High-Quality Driving Schools for you.</span></h1>
                                        <div class="text">Driver's Education courses in Castro Valley, San Leandro, Lorenzo, Dublin, Pleasanton DanvilleSan Lorenzo, Dublin, Pleasanton, Danville, San Ramon.</div>
                                        <div class="links-box clearfix">
                                            <div class="link"><a href="#" class="theme-btn btn-style-one"><span>Read More</span></a></div>
                                            <div class="link"><a href="#" class="theme-btn btn-style-two"><span>Book Now</span></a></div>
                                        </div>
                                    </div>
        ...
        <div class="auto-container">
            <div class="inner">
                <div class="content">
                    ...
                    <div class="phone"><a href="tel:+1 403.613.8074"><i class="icon far fa-phone"></i><span>+1 403.613.8074</span></a></div>
                </div>
            </div>
        </div>
        <div class="cursor cursor--large"></div>
    ...
    <section class="why-us">
        <div class="auto-container">
            <div class="title-box">
                <div class="dots"><span></span></div>
                <h2><i class="bg-vector"><img src="images/resource/title-pattern-1.svg" alt=""></i><span>Our Four-step Process</span></h2>
            </div>
            <div class="row clearfix">
              <div class="col-md-3">
                <div class="why-block">
                        <div class="inner-box">
                            ...
                            <h4>Call</h4>
                            <div class="text">Call us to find out the right driving lesson packages that suit your needs.</div>
                        </div>
                    </div>
              </div>  
              <div class="col-md-3">
    ...
    <section class="team-section d-none">
        ...
        <div class="auto-container">
            <div class="title-box centered">
                <div class="dots"><span></span></div>
                <h2><i class="bg-vector"><img src="images/resource/title-pattern-1.svg" alt=""></i><span>Meet Our Expert <br>Instructors</span></h2>
            </div>
            <div class="carousel-box">
                ...
                <div class="testi-carousel-one owl-theme owl-carousel">
                    ...
                    <div class="testi-block">
                        <div class="inner-box">
                            ...
                            <div class="text-content"><div class="text">Ipsum dolor sit amet, consectetur adipisicing elit sed do eiusmod tempor incididunt labore etuy dolore magna aduras minim veniam, quis nostrud exercitation ullamco enim ad minim veniam  quis nostrud exercitation ullamco duis autey irure dolor in reprehenderit  in voluptate velit esse cillum dolore.</div></div>
                            <div class="info">
    ...
    <section class="news-section d-none">
        <div class="auto-container">
            <div class="title-box centered">
                <div class="dots"><span></span></div>
                <h2><i class="bg-vector"><img src="images/resource/title-pattern-1.svg" alt=""></i><span>Latest news & <br>update</span></h2>
            </div>
            <div class="news-box">
                <div class="row clearfix">
                    <!--News Block-->
                    <div class="news-block col-xl-4 col-lg-6 col-md-6 col-sm-12">
                        <div class="inner-box wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="0ms">
                            <div class="image-box">
                                <div class="image"><a href="#"><img src="images/resource/news-1.jpg" alt="" title=""></a></div>
                            </div>
                            <div class="lower-box">
                                <div class="info">Personal   /   June 13, 2022</div>
                                <h4><a href="#">How to become a best driver Marketer in a year!</a></h4>
                                <div class="link-box"><a href="#" class="theme-btn">More Details <span class="icon far fa-long-arrow-right"></span></a></div>
                            </div>
                        </div>
                    </div>
                    <!--News Block-->
                    <div class="news-block col-xl-4 col-lg-6 col-md-6 col-sm-12">
                        <div class="inner-box wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="300ms">
                            <div class="image-box">
                                <div class="image"><a href="#"><img src="images/resource/news-2.jpg" alt="" title=""></a></div>
                            </div>
                            <div class="lower-box">
                                <div class="info">Personal   /   June 13, 2022</div>
                                <h4><a href="#">How to become a best driver Marketer in a year!</a></h4>
                    ...
                    <div class="news-block col-xl-4 col-lg-6 col-md-6 col-sm-12">
                        <div class="inner-box wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="600ms">
                            <div class="image-box">
                                <div class="image"><a href="#"><img src="images/resource/news-3.jpg" alt="" title=""></a></div>
                            </div>
                            <div class="lower-box">
                                <div class="info">Personal   /   June 13, 2022</div>
                                <h4><a href="#">How to become a best driver Marketer in a year!</a></h4>
